...
<div>
  <div class="whitesp d-block"></div>
    <div class="diver">
      <div class="content">
        <div class="head">
          <h2>{{ $t('information.termsofserv.head') }}</h2>
        </div>
        <div class="text">
          <div class="para">
            <div class="smhead">OVERVIEW</div>
            <p>This website is operated by Stabraq. Throughout the site, the terms “we”, “us” and “our” refer to Stabraq. Stabraq offers this website, including all information, tools and Services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.</p>
          </div>
          <div class="para">
          ...
          <div class="para">
            <div class="smhead">SECTION 1 - ONLINE STORE TERMS</div>
          ...
          <div class="para">
            <div class="smhead">SECTION 2 - GENERAL CONDITIONS</div>
          ...
          <div class="para">
            <div class="smhead">SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</div>
          ...
          <div class="para">
            <div class="smhead">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</div>
          ...
          <div class="para">
            <div class="smhead">SECTION 5 - PRODUCTS OR SERVICES (if applicable)</div>
